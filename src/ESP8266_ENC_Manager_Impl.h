...
#ifndef ESP8266_ENC_Manager_Impl_h
#define ESP8266_ENC_Manager_Impl_h
...
/**
   ...
   @access public
*/
ESP8266_EMParameter** ESP8266_ENC_Manager::getParameters()
{
  return _params;
}
...
/**
   ...
   @access public
*/
int ESP8266_ENC_Manager::getParametersCount()
{
  return _paramsCount;
}
...
char* ESP8266_ENC_Manager::getRFC952_hostname(const char* iHostname)
{
...
ESP8266_ENC_Manager::ESP8266_ENC_Manager(const char *iHostname)
{
...
#if USE_DYNAMIC_PARAMS
  bool ESP8266_ENC_Manager::addParameter(ESP8266_EMParameter *p)
#else
  void ESP8266_ENC_Manager::addParameter(ESP8266_EMParameter *p)
#endif
{
#if USE_DYNAMIC_PARAMS
...
void ESP8266_ENC_Manager::setupConfigPortal()
{
  ...
  server->on("/",         std::bind(&ESP8266_ENC_Manager::handleRoot,         this));
  server->on("/eth",      std::bind(&ESP8266_ENC_Manager::handleETH,          this));
  server->on("/ethsave",  std::bind(&ESP8266_ENC_Manager::handleETHSave,      this));
  server->on("/close",    std::bind(&ESP8266_ENC_Manager::handleServerClose,  this));
  server->on("/i",        std::bind(&ESP8266_ENC_Manager::handleInfo,         this));
  server->on("/r",        std::bind(&ESP8266_ENC_Manager::handleReset,        this));
  server->on("/state",    std::bind(&ESP8266_ENC_Manager::handleState,        this));
  //Microsoft captive portal. Maybe not needed. Might be handled by notFound handler.
  server->on("/fwlink",   std::bind(&ESP8266_ENC_Manager::handleRoot,         this));
  server->onNotFound(     std::bind(&ESP8266_ENC_Manager::handleNotFound,     this));
...
bool ESP8266_ENC_Manager::startConfigPortal()
{
  connect = false;
...
void ESP8266_ENC_Manager::setTimeout(const unsigned long& seconds)
{
...
void ESP8266_ENC_Manager::setConfigPortalTimeout(const unsigned long& seconds)
{
...
void ESP8266_ENC_Manager::setConnectTimeout(const unsigned long& seconds)
{
...
void ESP8266_ENC_Manager::setDebugOutput(bool debug)
{
  _debug = debug;
}
...
void ESP8266_ENC_Manager::setBreakAfterConfig(bool shouldBreak)
{
...
void ESP8266_ENC_Manager::reportStatus(String& page)
{
...
void ESP8266_ENC_Manager::setSTAStaticIPConfig(const IPAddress& ip, const IPAddress& gw, const IPAddress& sn)
{
...
void ESP8266_ENC_Manager::setSTAStaticIPConfig(const ETH_STA_IPConfig& EM_STA_IPconfig)
{
  LOGINFO(F("setSTAStaticIPConfig"));
...
void ESP8266_ENC_Manager::getSTAStaticIPConfig(ETH_STA_IPConfig& EM_STA_IPconfig)
{
...
void ESP8266_ENC_Manager::handleRoot()
{
...
void ESP8266_ENC_Manager::handleETH()
{
...
void ESP8266_ENC_Manager::handleETHSave()
{
  LOGDEBUG(F("ETH save"));
...
void ESP8266_ENC_Manager::handleServerClose()
{
...
void ESP8266_ENC_Manager::handleInfo()
{
  LOGDEBUG(F("Info"));
  ...
  page += F("<p/>More information about ESP8266_ENC_Manager at");
  page += F("<p/><a href=\"https://github.com/khoih-prog/ESP8266_ENC_Manager\">https://github.com/khoih-prog/ESP8266_ENC_Manager</a>");
  page += FPSTR(EM_HTTP_END);
...
void ESP8266_ENC_Manager::handleState()
{
...
void ESP8266_ENC_Manager::handleReset()
{
  LOGDEBUG(F("Reset"));
...
void ESP8266_ENC_Manager::handleNotFound()
{
  if (captivePortal())
  {
...
*/
bool ESP8266_ENC_Manager::captivePortal()
{
...
void ESP8266_ENC_Manager::setSaveConfigCallback(void(*func)())
{
  _savecallback = func;
}
...
void ESP8266_ENC_Manager::setCustomHeadElement(const char* element)
{
...
// Is this an IP?
bool ESP8266_ENC_Manager::isIp(const String& str)
{
...
// IP to String
String ESP8266_ENC_Manager::toStringIp(const IPAddress& ip)
{
  String res = "";
...
#endif    // ESP8266_ENC_Manager_Impl_h
