...
void setup()
{
  ...
  Serial.println(ESP8266_ENC_MANAGER_VERSION);
  ...
  ESP8266_ENC_manager.setDebugOutput(true);

#if !USE_DHCP_IP
  // Set (static IP, Gateway, Subnetmask, DNS1 and DNS2) or (IP, Gateway, Subnetmask)
  ESP8266_ENC_manager.setSTAStaticIPConfig(EthSTA_IPconfig);
#endif
  ...
  if (initialConfig)
  {
    ...
    //ESP8266_ENC_manager.setConfigPortalTimeout(600);
