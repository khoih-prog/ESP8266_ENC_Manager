...
1. For example, you already downloaded data files from [ESP_FSWebServer_DRD data](https://github.com/khoih-prog/ESP8266_ENC_Manager/tree/main/examples/ESP_FSWebServer_DRD/data) to a local folder, for example:


```
~/Arduino/libraries/ESP8266_ENC_Manager-main/examples/ESP_FSWebServer_DRD/data
```
...
```
Ubuntu$ cd ~/Arduino/libraries/ESP8266_ENC_Manager-main/examples/ESP_FSWebServer_DRD/data
...
<p align="center">
    <img src="https://github.com/khoih-prog/ESP8266_ENC_Manager/raw/main/examples/ESP_FSWebServer_DRD/pics/esp8266fs.local.png">
</p>

4. Edit / Delete / Download any file in the the folder by going to http://esp8266fs.local/edit.htm

<p align="center">
    <img src="https://github.com/khoih-prog/ESP8266_ENC_Manager/raw/main/examples/ESP_FSWebServer_DRD/pics/esp8266fs.local_edit.png">
</p>
